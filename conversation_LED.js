...
// Grovepi declaration
var GrovePi = require('../../../Desktop/GrovePi/Software/NodeJS/libs').GrovePi;
...
board = new GrovePi.board({
    ...
    onError: function(err){
    	console.log("GrovePi initialization failed: " + err);
    },
    onInit: function(res){
	console.log("GrovePi initialization succeed");
    }
})
